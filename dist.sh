...
[ -e target/arm-unknown-linux-gnueabihf/release/cadmus ] || ./build.sh
...
cp target/arm-unknown-linux-gnueabihf/release/cadmus dist/
cp contrib/*.sh dist
...
arm-linux-gnueabihf-strip dist/cadmus dist/libs/*
